...
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(c,r,x){c instanceof String&&(c=String(c));for(var z=c.length,A=0;A<z;A++){var G=c[A];if(r.call(x,G,A,c))return{i:A,v:G}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(c,r,x){c!=Array.prototype&&c!=Object.prototype&&(c[r]=x.value)};
$jscomp.getGlobal=function(c){return"undefined"!=typeof window&&window===c?c:"undefined"!=typeof global&&null!=global?global:c};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(c,r,x,z){if(r){x=$jscomp.global;c=c.split(".");for(z=0;z<c.length-1;z++){var A=c[z];A in x||(x[A]={});x=x[A]}c=c[c.length-1];z=x[c];r=r(z);r!=z&&null!=r&&$jscomp.defineProperty(x,c,{configurable:!0,writable:!0,value:r})}};
$jscomp.polyfill("Array.prototype.find",function(c){return c?c:function(c,x){return $jscomp.findInternal(this,c,x).v}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.Symbol=function(){var c=0;return function(r){return $jscomp.SYMBOL_PREFIX+(r||"")+c++}}();
...
$jscomp.iteratorPrototype=function(c){$jscomp.initSymbolIterator();c={next:c};c[$jscomp.global.Symbol.iterator]=function(){return this};return c};$jscomp.iteratorFromArray=function(c,r){$jscomp.initSymbolIterator();c instanceof String&&(c+="");var x=0,z={next:function(){if(x<c.length){var A=x++;return{value:r(A,c[A]),done:!1}}z.next=function(){return{done:!0,value:void 0}};return z.next()}};z[Symbol.iterator]=function(){return z};return z};
$jscomp.polyfill("Array.prototype.values",function(c){return c?c:function(){return $jscomp.iteratorFromArray(this,function(c,x){return x})}},"es6","es3");
window.game.actions={portrait:{wrapper:"#user-info",pic:"#img_portrait",portrait:".user-portrait",name:".user-name",level:".user-level",progress:{text:".progress-text",line:".progress-line"},init:function(){this.setupHp();this.setupImg();this.setupName();this.setupLevel();$(this.wrapper+" "+this.portrait).click(function(){$(window.game.actions.profile.wrapper).show()})},setupName:function(){$(this.wrapper+" "+this.name).text(window.game.player.name)},setupImg:function(){var c="/img/player/avatar/v"+
window.game.player.img+".jpg";$(this.pic).attr("src",c)},setupLevel:function(){$(this.wrapper+" "+this.level).text(window.game.player.level)},setupHp:function(){var c=window.game.player.hp.real,r=window.game.player.hp.max,x=$(this.wrapper),z=c/r*100;x.find(this.progress.text).text(c+" / "+r);x.find(this.progress.line).css({width:z+"%"})}},personage:{init:function(){this.hp.regen()},hp:{regen:function(){var c=window.game.player.hp;setInterval(function(){c.real+=c.max/100;c.real>c.max&&(c.real=c.max);
window.game.actions.portrait.setupHp();window.game.save()},6E4*window.game.props.x.regen/100/window.game.props.x.speed)},damage:function(c){var r=window.game.player.hp;r.real-=c;0>r.real&&(r.real=0);window.game.actions.portrait.setupHp();window.game.save()},heal:function(c){var r=window.game.player.hp;r.real+=c;r.real>r.max&&(r.real=r.max);window.game.actions.portrait.setupHp();window.game.save()}},lelelUp:function(c){c=window.game.actions.profile.stats;$(c.wrapper+" "+c.button).show()}},profile:{wrapper:"#profile",
title:".profile-tilte",items:{info:"profile-info",stats:"profile-stats",inventory:"profile-inventory"},tabs:{item:".tabs-item",body:".tabs-body"},init:function(){this.info.setImg();this.setTitle(window.game.player.name);this.stats.render.all();$(this.wrapper).draggable({handle:this.title});var c=this;$(this.tabs.item).click(function(){var r=$(this);$(c.wrapper+" "+c.tabs.body).hide();$(c.wrapper+" "+c.tabs.body).filter(r.attr("href")).show()});$(this.stats.wrapper+" "+this.stats.button).click(function(r){r.preventDefault();
r=$(this).attr("href");c.stats.upgrade[r]();return!1})},setTitle:function(c){$(this.wrapper+" "+this.title).text(c)},info:{img:"#img_personage",setName:function(){},setImg:function(){$(this.img).attr("src","/img/player/v"+window.game.player.img+".jpg")}},stats:{wrapper:"#profile-stats",button:".stats-upgrade",str:"str",dex:"dex",luk:"luk",stm:"stm",free:"free",render:{all:function(){this.str();this.dex();this.luk();this.stm()},common:function(c){var r=window.game.actions.profile.stats,x=window.game.player.stats;
$(r.wrapper+" .points."+r[c]).text(x[c]);$(r.wrapper+" .points."+r.free).text(x.free);0>=x.free&&$(r.wrapper+" "+r.button).hide()},str:function(){this.common("str")},dex:function(){this.common("dex")},luk:function(){this.common("luk")},stm:function(){this.common("stm")},free:function(){this.common("free")}},upgrade:{common:function(c){var r=window.game.player.stats;if(0>=r.free)return!1;r[c]+=1;r.free--;window.game.save(function(){window.game.actions.profile.stats.render[c]()})},str:function(){this.common("str")},
dex:function(){this.common("dex")},luk:function(){this.common("luk")},stm:function(){this.common("stm")}}},inventory:{}},goTo:function(c){},enemy:{add:function(c){},clear:function(){}},gold:{need:function(c){return window.game.player.gold>c},add:function(c){window.game.player.gold+=c},remove:function(c){window.game.player.gold-=c}},item:{add:function(c){},remove:function(c){},equip:function(c){},drop:function(c){},sell:function(c){var r=window.game.items[c];this.remove(c);window.game.actions.gold.add(r.sell)},
bye:function(c){c=window.game.items[c];window.game.gold.need(c.bye)&&(this.add(c),window.game.actions.gold.remove(c.bye))}},stats:{add:function(c){window.game.player.stats[c]++;window.game.player.stats.free--}}};window.game.enemy={id:0,lvl:0,hp:0};var createItem=function(c,r,x,z,A){return{name:c,type:r,dmg:x,def:z,bye:A,sell:A/2}};window.game.items=[];window.game.items.push(createItem("\u041f\u0430\u043b\u043a\u0430",1,3,0,10));
window.game.items.push(createItem("\u0422\u0440\u0443\u0431\u0430",1,5,0,16));window.game.items.push(createItem("\u0420\u0443\u0431\u0430\u0445\u0430",2,0,2,12));window.game.items.push(createItem("\u0414\u0432\u0435\u0440\u0446\u0430",0,0,5,28));window.game.items.push(createItem("\u041a\u0443\u0440\u0438\u043d\u043e\u0435 \u043f\u0435\u0440\u043e",0,0,0,!1));var createMob=function(c,r,x,z,A){return{name:c,hp:r,dmg:{min:x,max:2*x},exp:z,img:A}};window.game.mobs=[];
window.game.mobs.push(createMob("\u041a\u0443\u0440\u043e\u0447\u043a\u0430",10,3,10,"chiken"));window.game.mobs.push(createMob("\u041a\u0430\u0431\u0430\u043d",25,5,25,"borov"));window.game.player={status:0,level:1,name:"",exp:1,img:0,hp:{real:50,max:50},dmg:{min:4,max:6},def:0,gold:100,stats:{str:5,dex:5,luk:5,stm:5,free:5},equip:{0:!1,1:!1,2:!1,3:!1},chance:{block:5,dodge:5},inventory:[0,1]};
window.game.props={x:{speed:1,regen:10,gold:1,sell:1,bye:1},itemTypes:{0:"chest",1:"main hand",2:"second hand",3:"trash",4:"potion",5:"quests"},levels:[0,50,150,300,500,750,1E3,1500,3E3,5E3,1E4]};window.game.sys={rand:function(c,r){},damage:function(c){return self.rand(c.min,c.max)},render:{personage:{info:function(){},stats:function(){},inventory:function(){}},location:{}}};
window.game={load:{init:function(){var c=["form","game"];void 0!=localStorage.getItem("player")&&(window.game.player=JSON.parse(localStorage.getItem("player")));c=c[window.game.player.status];$("#"+c).show();this[c].init()},game:{init:function(){window.game.actions.profile.init();window.game.actions.portrait.init();window.game.actions.personage.init();$("A.close-wrapper").click(function(){$(this).parent().hide()})}},form:{init:function(){$('[name\x3d"avatar"]').change(function(){var c="/img/player/v"+
$(this).attr("value")+".jpg";$("#reg_avatar").attr("src",c)});$(".form.registry").submit(function(c){c.preventDefault();c=window.game.player;var r=$('[name\x3d"avatar"]:checked').attr("value");c.name=$("#reg-nickname").val();c.img=r;c.status=1;window.game.save(function(){window.location.reload()});return!1})}}},save:function(c){localStorage.setItem("player",JSON.stringify(window.game.player));void 0!=c&&c()},reset:function(){localStorage.clear("player")},props:{},sys:{},player:{},enemy:{},actions:{},
items:[],mobs:[],xxx:[]};$(document).ready(function(){window.game.load.init()});
(function(c){"function"==typeof define&&define.amd?define(["jquery"],c):c(jQuery)})(function(c){function r(a){for(var b,c;a.length&&a[0]!==document;){if(b=a.css("position"),("absolute"===b||"relative"===b||"fixed"===b)&&(c=parseInt(a.css("zIndex"),10),!isNaN(c)&&0!==c))return c;a=a.parent()}return 0}function x(){this._curInst=null;this._keyEvent=!1;this._disabledInputs=[];this._inDialog=this._datepickerShowing=!1;this._mainDivId="ui-datepicker-div";this._inlineClass="ui-datepicker-inline";this._appendClass=
...
this.regional[""]);this.regional.en=c.extend(!0,{},this.regional[""]);this.regional["en-US"]=c.extend(!0,{},this.regional.en);this.dpDiv=z(c("\x3cdiv id\x3d'"+this._mainDivId+"' class\x3d'ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'\x3e\x3c/div\x3e"))}function z(a){return a.on("mouseout","button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a",function(){c(this).removeClass("ui-state-hover");-1!==this.className.indexOf("ui-datepicker-prev")&&
c(this).removeClass("ui-datepicker-prev-hover");-1!==this.className.indexOf("ui-datepicker-next")&&c(this).removeClass("ui-datepicker-next-hover")}).on("mouseover","button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a",A)}function A(){c.datepicker._isDisabledDatepicker(J.inline?J.dpDiv.parent()[0]:J.input[0])||(c(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),c(this).addClass("ui-state-hover"),-1!==this.className.indexOf("ui-datepicker-prev")&&
c(this).addClass("ui-datepicker-prev-hover"),-1!==this.className.indexOf("ui-datepicker-next")&&c(this).addClass("ui-datepicker-next-hover"))}function G(a,b){c.extend(a,b);for(var d in b)null==b[d]&&(a[d]=b[d]);return a}function I(a){return function(){var b=this.element.val();a.apply(this,arguments);this._refresh();b!==this.element.val()&&this._trigger("change")}}c.ui=c.ui||{};c.ui.version="1.12.1";var Q=0,M=Array.prototype.slice;c.cleanData=function(a){return function(b){var d,e,f;for(f=0;null!=
(e=b[f]);f++)try{(d=c._data(e,"events"))&&d.remove&&c(e).triggerHandler("remove")}catch(g){}a(b)}}(c.cleanData);c.widget=function(a,b,d){var e,f,g,h={},k=a.split(".")[0];a=a.split(".")[1];var l=k+"-"+a;return d||(d=b,b=c.Widget),c.isArray(d)&&(d=c.extend.apply(null,[{}].concat(d))),c.expr[":"][l.toLowerCase()]=function(a){return!!c.data(a,l)},c[k]=c[k]||{},e=c[k][a],f=c[k][a]=function(a,b){return this._createWidget?(arguments.length&&this._createWidget(a,b),void 0):new f(a,b)},c.extend(f,e,{version:d.version,
_proto:c.extend({},d),_childConstructors:[]}),g=new b,g.options=c.widget.extend({},g.options),c.each(d,function(a,d){return c.isFunction(d)?(h[a]=function(){function c(){return b.prototype[a].apply(this,arguments)}function e(c){return b.prototype[a].apply(this,c)}return function(){var a,b=this._super,f=this._superApply;return this._super=c,this._superApply=e,a=d.apply(this,arguments),this._super=b,this._superApply=f,a}}(),void 0):(h[a]=d,void 0)}),f.prototype=c.widget.extend(g,{widgetEventPrefix:e?
g.widgetEventPrefix||a:a},h,{constructor:f,namespace:k,widgetName:a,widgetFullName:l}),e?(c.each(e._childConstructors,function(a,b){a=b.prototype;c.widget(a.namespace+"."+a.widgetName,f,b._proto)}),delete e._childConstructors):b._childConstructors.push(f),c.widget.bridge(a,f),f};c.widget.extend=function(a){for(var b,d,e=M.call(arguments,1),f=0,g=e.length;g>f;f++)for(b in e[f])d=e[f][b],e[f].hasOwnProperty(b)&&void 0!==d&&(a[b]=c.isPlainObject(d)?c.isPlainObject(a[b])?c.widget.extend({},a[b],d):c.widget.extend({},
d):d);return a};c.widget.bridge=function(a,b){var d=b.prototype.widgetFullName||a;c.fn[a]=function(e){var f="string"==typeof e,g=M.call(arguments,1),h=this;return f?this.length||"instance"!==e?this.each(function(){var b,f=c.data(this,d);return"instance"===e?(h=f,!1):f?c.isFunction(f[e])&&"_"!==e.charAt(0)?(b=f[e].apply(f,g),b!==f&&void 0!==b?(h=b&&b.jquery?h.pushStack(b.get()):b,!1):void 0):c.error("no such method '"+e+"' for "+a+" widget instance"):c.error("cannot call methods on "+a+" prior to initialization; attempted to call method '"+
e+"'")}):h=void 0:(g.length&&(e=c.widget.extend.apply(null,[e].concat(g))),this.each(function(){var a=c.data(this,d);a?(a.option(e||{}),a._init&&a._init()):c.data(this,d,new b(e,this))})),h}};c.Widget=function(){};c.Widget._childConstructors=[];c.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",defaultElement:"\x3cdiv\x3e",options:{classes:{},disabled:!1,create:null},_createWidget:function(a,b){b=c(b||this.defaultElement||this)[0];this.element=c(b);this.uuid=Q++;this.eventNamespace="."+
...
height:a.height(),offset:{top:a.scrollTop(),left:a.scrollLeft()}}:b.preventDefault?{width:0,height:0,offset:{top:b.pageY,left:b.pageX}}:{width:a.outerWidth(),height:a.outerHeight(),offset:a.offset()}}var d,e=Math.max,f=Math.abs,g=/left|center|right/,h=/top|center|bottom/,k=/[\+\-]\d+(\.[\d]+)?%?/,l=/^\w+/,m=/%$/,n=c.fn.position;c.position={scrollbarWidth:function(){if(void 0!==d)return d;var a,b,e=c("\x3cdiv style\x3d'display:block;position:absolute;width:50px;height:50px;overflow:hidden;'\x3e\x3cdiv style\x3d'height:100px;width:auto;'\x3e\x3c/div\x3e\x3c/div\x3e"),
...
getWithinInfo:function(a){var b=c(a||window),d=c.isWindow(b[0]),e=!!b[0]&&9===b[0].nodeType;return{element:b,isWindow:d,isDocument:e,offset:d||e?{left:0,top:0}:c(a).offset(),scrollLeft:b.scrollLeft(),scrollTop:b.scrollTop(),width:b.outerWidth(),height:b.outerHeight()}}};c.fn.position=function(d){if(!d||!d.of)return n.apply(this,arguments);d=c.extend({},d);var q,m,t,v,w,p,E=c(d.of),P=c.position.getWithinInfo(d.within),y=c.position.getScrollInfo(P),B=(d.collision||"flip").split(" "),F={};return p=b(E),
E[0].preventDefault&&(d.at="left top"),m=p.width,t=p.height,v=p.offset,w=c.extend({},v),c.each(["my","at"],function(){var a=(d[this]||"").split(" ");1===a.length&&(a=g.test(a[0])?a.concat(["center"]):h.test(a[0])?["center"].concat(a):["center","center"]);a[0]=g.test(a[0])?a[0]:"center";a[1]=h.test(a[1])?a[1]:"center";var b=k.exec(a[0]);var c=k.exec(a[1]);F[this]=[b?b[0]:0,c?c[0]:0];d[this]=[l.exec(a[0])[0],l.exec(a[1])[0]]}),1===B.length&&(B[1]=B[0]),"right"===d.at[0]?w.left+=m:"center"===d.at[0]&&
(w.left+=m/2),"bottom"===d.at[1]?w.top+=t:"center"===d.at[1]&&(w.top+=t/2),q=a(F.at,m,t),w.left+=q[0],w.top+=q[1],this.each(function(){var b,g=c(this),h=g.outerWidth(),k=g.outerHeight(),l=parseInt(c.css(this,"marginLeft"),10)||0,p=parseInt(c.css(this,"marginTop"),10)||0,n=h+l+(parseInt(c.css(this,"marginRight"),10)||0)+y.width,D=k+p+(parseInt(c.css(this,"marginBottom"),10)||0)+y.height,u=c.extend({},w),r=a(F.my,g.outerWidth(),g.outerHeight());"right"===d.my[0]?u.left-=h:"center"===d.my[0]&&(u.left-=
h/2);"bottom"===d.my[1]?u.top-=k:"center"===d.my[1]&&(u.top-=k/2);u.left+=r[0];u.top+=r[1];var x={marginLeft:l,marginTop:p};c.each(["left","top"],function(a,b){c.ui.position[B[a]]&&c.ui.position[B[a]][b](u,{targetWidth:m,targetHeight:t,elemWidth:h,elemHeight:k,collisionPosition:x,collisionWidth:n,collisionHeight:D,offset:[q[0]+r[0],q[1]+r[1]],my:d.my,at:d.at,within:P,elem:g})});d.using&&(b=function(a){var b=v.left-u.left,c=b+m-h,l=v.top-u.top,q=l+t-k,p={target:{element:E,left:v.left,top:v.top,width:m,
height:t},element:{element:g,left:u.left,top:u.top,width:h,height:k},horizontal:0>c?"left":0<b?"right":"center",vertical:0>q?"top":0<l?"bottom":"middle"};h>m&&m>f(b+c)&&(p.horizontal="center");k>t&&t>f(l+q)&&(p.vertical="middle");p.important=e(f(b),f(c))>e(f(l),f(q))?"horizontal":"vertical";d.using.call(this,a,p)});g.offset(c.extend(u,{using:b}))})};c.ui.position={fit:{left:function(a,b){var c,d=b.within,f=d.isWindow?d.scrollLeft:d.offset.left;d=d.width;var g=a.left-b.collisionPosition.marginLeft,
...
a):this.form.removeData("ui-form-reset-instances").off("reset.ui-form-reset")}}};"1.7"===c.fn.jquery.substring(0,3)&&(c.each(["Width","Height"],function(a,b){function d(a,b,d,f){return c.each(e,function(){b-=parseFloat(c.css(a,"padding"+this))||0;d&&(b-=parseFloat(c.css(a,"border"+this+"Width"))||0);f&&(b-=parseFloat(c.css(a,"margin"+this))||0)}),b}var e="Width"===b?["Left","Right"]:["Top","Bottom"],f=b.toLowerCase(),g={innerWidth:c.fn.innerWidth,innerHeight:c.fn.innerHeight,outerWidth:c.fn.outerWidth,
outerHeight:c.fn.outerHeight};c.fn["inner"+b]=function(a){return void 0===a?g["inner"+b].call(this):this.each(function(){c(this).css(f,d(this,a)+"px")})};c.fn["outer"+b]=function(a,e){return"number"!=typeof a?g["outer"+b].call(this,a):this.each(function(){c(this).css(f,d(this,a,!0,e)+"px")})}}),c.fn.addBack=function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))});c.ui.keyCode={BACKSPACE:8,COMMA:188,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,LEFT:37,PAGE_DOWN:34,PAGE_UP:33,
...
0;return function(){return this.each(function(){this.id||(this.id="ui-id-"+ ++a)})}}(),removeUniqueId:function(){return this.each(function(){/^ui-id-\d+$/.test(this.id)&&c(this).removeAttr("id")})}});c.ui.ie=!!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase());var K=!1;c(document).on("mouseup",function(){K=!1});c.widget("ui.mouse",{version:"1.12.1",options:{cancel:"input, textarea, button, select, option",distance:1,delay:0},_mouseInit:function(){var a=this;this.element.on("mousedown."+this.widgetName,
function(b){return a._mouseDown(b)}).on("click."+this.widgetName,function(b){return!0===c.data(b.target,a.widgetName+".preventClickEvent")?(c.removeData(b.target,a.widgetName+".preventClickEvent"),b.stopImmediatePropagation(),!1):void 0});this.started=!1},_mouseDestroy:function(){this.element.off("."+this.widgetName);this._mouseMoveDelegate&&this.document.off("mousemove."+this.widgetName,this._mouseMoveDelegate).off("mouseup."+this.widgetName,this._mouseUpDelegate)},_mouseDown:function(a){if(!K){this._mouseMoved=
...
!0):(!0===c.data(a.target,this.widgetName+".preventClickEvent")&&c.removeData(a.target,this.widgetName+".preventClickEvent"),this._mouseMoveDelegate=function(a){return b._mouseMove(a)},this._mouseUpDelegate=function(a){return b._mouseUp(a)},this.document.on("mousemove."+this.widgetName,this._mouseMoveDelegate).on("mouseup."+this.widgetName,this._mouseUpDelegate),a.preventDefault(),K=!0,!0)):!0}},_mouseMove:function(a){if(this._mouseMoved){if(c.ui.ie&&(!document.documentMode||9>document.documentMode)&&
...
!this._mouseStarted)},_mouseUp:function(a){this.document.off("mousemove."+this.widgetName,this._mouseMoveDelegate).off("mouseup."+this.widgetName,this._mouseUpDelegate);this._mouseStarted&&(this._mouseStarted=!1,a.target===this._mouseDownEvent.target&&c.data(a.target,this.widgetName+".preventClickEvent",!0),this._mouseStop(a));this._mouseDelayTimer&&(clearTimeout(this._mouseDelayTimer),delete this._mouseDelayTimer);K=this.ignoreMissingWhich=!1;a.preventDefault()},_mouseDistanceMet:function(a){return Math.max(Math.abs(this._mouseDownEvent.pageX-
...
b[e][1].apply(a.element,c)}};c.ui.safeActiveElement=function(a){try{var b=a.activeElement}catch(d){b=a.body}return b||(b=a.body),b.nodeName||(b=a.body),b};c.ui.safeBlur=function(a){a&&"body"!==a.nodeName.toLowerCase()&&c(a).trigger("blur")};c.widget("ui.draggable",c.ui.mouse,{version:"1.12.1",widgetEventPrefix:"drag",options:{addClasses:!0,appendTo:"parent",axis:!1,connectToSortable:!1,containment:!1,cursor:"auto",cursorAt:!1,grid:!1,handle:!1,helper:"original",iframeFix:!1,opacity:!1,refreshPositions:!1,
...
return c("\x3cdiv\x3e").css("position","absolute").appendTo(a.parent()).outerWidth(a.outerWidth()).outerHeight(a.outerHeight()).offset(a.offset())[0]})},_unblockFrames:function(){this.iframeBlocks&&(this.iframeBlocks.remove(),delete this.iframeBlocks)},_blurActiveElement:function(a){var b=c.ui.safeActiveElement(this.document[0]);c(a.target).closest(b).length||c.ui.safeBlur(b)},_mouseStart:function(a){var b=this.options;return this.helper=this._createHelper(a),this._addClass(this.helper,"ui-draggable-dragging"),
...
b.currentItem||b.element)&&(this._removeHoverClass(),this._trigger("out",a,this.ui(b)))},_drop:function(a,b){var d=b||c.ui.ddmanager.current,e=!1;return d&&(d.currentItem||d.element)[0]!==this.element[0]?(this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function(){var b=c(this).droppable("instance");return b.options.greedy&&!b.options.disabled&&b.options.scope===d.options.scope&&b.accept.call(b.element[0],d.currentItem||d.element)&&L(d,c.extend(b,{offset:b.element.offset()}),
b.options.tolerance,a)?(e=!0,!1):void 0}),e?!1:this.accept.call(this.element[0],d.currentItem||d.element)?(this._removeActiveClass(),this._removeHoverClass(),this._trigger("drop",a,this.ui(d)),this.element):!1):!1},ui:function(a){return{draggable:a.currentItem||a.element,helper:a.helper,position:a.position,offset:a.positionAbs}},_addHoverClass:function(){this._addClass("ui-droppable-hover")},_removeHoverClass:function(){this._removeClass("ui-droppable-hover")},_addActiveClass:function(){this._addClass("ui-droppable-active")},
_removeActiveClass:function(){this._removeClass("ui-droppable-active")}});var L=c.ui.intersect=function(){return function(a,b,c,e){if(!b.offset)return!1;var d=(a.positionAbs||a.position.absolute).left+a.margins.left,g=(a.positionAbs||a.position.absolute).top+a.margins.top,h=d+a.helperProportions.width,k=g+a.helperProportions.height,l=b.offset.left,m=b.offset.top,n=l+b.proportions().width,p=m+b.proportions().height;switch(c){case "fit":return d>=l&&n>=h&&g>=m&&p>=k;case "intersect":return d+a.helperProportions.width/
2>l&&n>h-a.helperProportions.width/2&&g+a.helperProportions.height/2>m&&p>k-a.helperProportions.height/2;case "pointer":a=e.pageY;c=b.proportions().height;if(m=a>=m&&m+c>a)e=e.pageX,b=b.proportions().width,m=e>=l&&l+b>e;return m;case "touch":return(g>=m&&p>=g||k>=m&&p>=k||m>g&&k>p)&&(d>=l&&n>=d||h>=l&&n>=h||l>d&&h>n);default:return!1}}}();c.ui.ddmanager={current:null,droppables:{"default":[]},prepareOffsets:function(a,b){var d,e=c.ui.ddmanager.droppables[a.options.scope]||[],f=b?b.type:null,g=(a.currentItem||
...
b){var d=!1;return c.each((c.ui.ddmanager.droppables[a.options.scope]||[]).slice(),function(){this.options&&(!this.options.disabled&&this.visible&&L(a,this,this.options.tolerance,b)&&(d=this._drop.call(this,b)||d),!this.options.disabled&&this.visible&&this.accept.call(this.element[0],a.currentItem||a.element)&&(this.isout=!0,this.isover=!1,this._deactivate.call(this,b)))}),d},dragStart:function(a,b){a.element.parentsUntil("body").on("scroll.droppable",function(){a.options.refreshPositions||c.ui.ddmanager.prepareOffsets(a,
b)})},drag:function(a,b){a.options.refreshPositions&&c.ui.ddmanager.prepareOffsets(a,b);c.each(c.ui.ddmanager.droppables[a.options.scope]||[],function(){if(!this.options.disabled&&!this.greedyChild&&this.visible){var d,e,f,g=L(a,this,this.options.tolerance,b);(g=!g&&this.isover?"isout":g&&!this.isover?"isover":null)&&(this.options.greedy&&(e=this.options.scope,f=this.element.parents(":data(ui-droppable)").filter(function(){return c(this).droppable("instance").options.scope===e}),f.length&&(d=c(f[0]).droppable("instance"),
...
"n,e,s,w,se,sw,ne,nw");var e=this.handles.split(",");this.handles={};for(a=0;e.length>a;a++){var f=c.trim(e[a]);var g="ui-resizable-"+f;var h=c("\x3cdiv\x3e");this._addClass(h,"ui-resizable-handle "+g);h.css({zIndex:b.zIndex});this.handles[f]=".ui-resizable-"+f;this.element.append(h)}}this._renderAxis=function(a){var b,e,f,g;a=a||this.element;for(b in this.handles)this.handles[b].constructor===String?this.handles[b]=this.element.children(this.handles[b]).first().show():(this.handles[b].jquery||this.handles[b].nodeType)&&
...
h,k=c(this).resizable("instance"),l=k.element,m=k.options.containment;(l=m instanceof c?m.get(0):/parent/.test(m)?l.parent().get(0):m)&&(k.containerElement=c(l),/document/.test(m)||m===document?(k.containerOffset={left:0,top:0},k.containerPosition={left:0,top:0},k.parentData={element:c(document),left:0,top:0,width:c(document).width(),height:c(document).height()||document.body.parentNode.scrollHeight}):(a=c(l),b=[],c(["Top","Right","Left","Bottom"]).each(function(c,d){b[c]=k._num(a.css("padding"+d))}),
k.containerOffset=a.offset(),k.containerPosition=a.position(),k.containerSize={height:a.innerHeight()-b[3],width:a.innerWidth()-b[1]},d=k.containerOffset,e=k.containerSize.height,f=k.containerSize.width,g=k._hasScroll(l,"left")?l.scrollWidth:f,h=k._hasScroll(l)?l.scrollHeight:e,k.parentData={element:l,left:d.left,top:d.top,width:g,height:h}))},resize:function(a){var b=c(this).resizable("instance");var d=b.options;var e=b.containerOffset;var f=b.position;a=b._aspectRatio||a.shiftKey;var g={top:0,left:0},
...
f.width)/l)*l;e=Math.round((e.height-f.height)/m)*m;var p=f.width+n,q=f.height+e,u=d.maxWidth&&p>d.maxWidth,t=d.maxHeight&&q>d.maxHeight,v=d.minWidth&&d.minWidth>p,w=d.minHeight&&d.minHeight>q;d.grid=k;v&&(p+=l);w&&(q+=m);u&&(p-=l);t&&(q-=m);/^(se|s|e)$/.test(h)?(b.size.width=p,b.size.height=q):/^(ne)$/.test(h)?(b.size.width=p,b.size.height=q,b.position.top=g.top-e):/^(sw)$/.test(h)?(b.size.width=p,b.size.height=q,b.position.left=g.left-n):((0>=q-m||0>=p-l)&&(a=b._getPaddingPlusBorderDimensions(this)),
0<q-m?(b.size.height=q,b.position.top=g.top-e):(q=m-a.height,b.size.height=q,b.position.top=g.top+f.height-q),0<p-l?(b.size.width=p,b.position.left=g.left-n):(p=l-a.width,b.size.width=p,b.position.left=g.left+f.width-p))}});c.ui.resizable;c.widget("ui.selectable",c.ui.mouse,{version:"1.12.1",options:{appendTo:"body",autoRefresh:!0,distance:0,filter:"*",tolerance:"touch",selected:null,selecting:null,start:null,stop:null,unselected:null,unselecting:null},_create:function(){var a=this;this._addClass("ui-selectable");
...
c.data(this,"selectable-item"),m=!1,n,p,q,u;b&&b.element!==d.element[0]&&(n=b.left+d.elementPos.left,p=b.right+d.elementPos.left,q=b.top+d.elementPos.top,u=b.bottom+d.elementPos.top,"touch"===e.tolerance?m=!(n>h||f>p||q>k||g>u):"fit"===e.tolerance&&(m=n>f&&h>p&&q>g&&k>u),m?(b.selected&&(d._removeClass(b.$element,"ui-selected"),b.selected=!1),b.unselecting&&(d._removeClass(b.$element,"ui-unselecting"),b.unselecting=!1),b.selecting||(d._addClass(b.$element,"ui-selecting"),b.selecting=!0,d._trigger("selecting",
...
e])}g.push([c.isFunction(this.options.items)?this.options.items.call(this.element,null,{options:this.options,item:this.currentItem}):c(this.options.items,this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),this]);for(a=g.length-1;0<=a;a--)g[a][0].each(b);return c(f)},_removeCurrentsFromItems:function(){var a=this.currentItem.find(":data("+this.widgetName+"-item)");this.items=c.grep(this.items,function(b){for(var c=0;a.length>c;c++)if(a[c]===b.item[0])return!1;return!0})},_refreshItems:function(a){this.items=
...
this._storedCSS[e]&&"static"!==this._storedCSS[e]||(this._storedCSS[e]="");this.currentItem.css(this._storedCSS);this._removeClass(this.currentItem,"ui-sortable-helper")}else this.currentItem.show();this.fromOutside&&!b&&f.push(function(a){this._trigger("receive",a,this._uiHash(this.fromOutside))});!this.fromOutside&&this.domPosition.prev===this.currentItem.prev().not(".ui-sortable-helper")[0]&&this.domPosition.parent===this.currentItem.parent()[0]||b||f.push(function(a){this._trigger("update",a,
...
parseInt(c(this).attr("tabIndex"),10)}).attr("tabIndex",-1);b.attr("aria-hidden","false").prev().attr({"aria-selected":"true","aria-expanded":"true",tabIndex:0})},_animate:function(a,b,c){var d,f,g,h=this,k=0,l=a.css("box-sizing"),m=a.length&&(!b.length||a.index()<b.index()),n=this.options.animate||{};m=m&&n.down||n;var p=function(){h._toggleComplete(c)};return"number"==typeof m&&(g=m),"string"==typeof m&&(f=m),f=f||m.easing||n.easing,g=g||m.duration||n.duration,b.length?a.length?(d=a.show().outerHeight(),
b.animate(this.hideProps,{duration:g,easing:f,step:function(a,b){b.now=Math.round(a)}}),a.hide().animate(this.showProps,{duration:g,easing:f,complete:p,step:function(a,c){c.now=Math.round(a);"height"!==c.prop?"content-box"===l&&(k+=c.now):"content"!==h.options.heightStyle&&(c.now=Math.round(d-b.outerHeight()-k),k=0)}}),void 0):b.animate(this.hideProps,g,f,p):a.animate(this.showProps,g,f,p)},_toggleComplete:function(a){var b=a.oldPanel,c=b.prev();this._removeClass(b,"ui-accordion-content-active");
...
this.element.attr("aria-activedescendant",c.attr("id"));c=this.active.parent().closest(".ui-menu-item").children(".ui-menu-item-wrapper");this._addClass(c,null,"ui-state-active");a&&"keydown"===a.type?this._close():this.timer=this._delay(function(){this._close()},this.delay);c=b.children(".ui-menu");c.length&&a&&/^mouse/.test(a.type)&&this._startOpening(c);this.activeMenu=b.parent();this._trigger("focus",a,{item:b})},_scrollIntoView:function(a){var b,d,e,f,g,h;this._hasScroll()&&(b=parseFloat(c.css(this.activeMenu[0],
...
(a=!0,e.preventDefault(),this.menu.select(e));break;case f.TAB:this.menu.active&&this.menu.select(e);break;case f.ESCAPE:this.menu.element.is(":visible")&&(this.isMultiLine||this._value(this.term),this.close(e),e.preventDefault());break;default:b=!0,this._searchTimeout(e)}},keypress:function(d){if(a)return a=!1,(!this.isMultiLine||this.menu.element.is(":visible"))&&d.preventDefault(),void 0;if(!b){var e=c.ui.keyCode;switch(d.keyCode){case e.PAGE_UP:this._move("previousPage",d);break;case e.PAGE_DOWN:this._move("nextPage",
d);break;case e.UP:this._keyEvent("previous",d);break;case e.DOWN:this._keyEvent("next",d)}}},input:function(a){return d?(d=!1,a.preventDefault(),void 0):(this._searchTimeout(a),void 0)},focus:function(){this.selectedItem=null;this.previous=this._value()},blur:function(a){return this.cancelBlur?(delete this.cancelBlur,void 0):(clearTimeout(this.searching),this.close(a),this._change(a),void 0)}});this._initSource();this.menu=c("\x3cul\x3e").appendTo(this._appendTo()).menu({role:null}).hide().menu("instance");
this._addClass(this.menu.element,"ui-autocomplete","ui-front");this._on(this.menu.element,{mousedown:function(a){a.preventDefault();this.cancelBlur=!0;this._delay(function(){delete this.cancelBlur;this.element[0]!==c.ui.safeActiveElement(this.document[0])&&this.element.trigger("focus")})},menufocus:function(a,b){var d,e;return this.isNewMenu&&(this.isNewMenu=!1,a.originalEvent&&/^mouse/.test(a.originalEvent.type))?(this.menu.blur(),this.document.one("mousemove",function(){c(a.target).trigger(a.originalEvent)}),
void 0):(e=b.item.data("ui-autocomplete-item"),!1!==this._trigger("focus",a,{item:e})&&a.originalEvent&&/^key/.test(a.originalEvent.type)&&this._value(e.value),d=b.item.attr("aria-label")||e.value,d&&c.trim(d).length&&(this.liveRegion.children().hide(),c("\x3cdiv\x3e").text(d).appendTo(this.liveRegion)),void 0)},menuselect:function(a,b){var d=b.item.data("ui-autocomplete-item"),e=this.previous;this.element[0]!==c.ui.safeActiveElement(this.document[0])&&(this.element.trigger("focus"),this.previous=
...
function(d,e){var f,g={};return e?"controlgroupLabel"===d?(f=a.element.find(e),f.each(function(){var a=c(this);a.children(".ui-controlgroup-label-contents").length||a.contents().wrapAll("\x3cspan class\x3d'ui-controlgroup-label-contents'\x3e\x3c/span\x3e")}),a._addClass(f,null,"ui-widget ui-widget-content ui-state-default"),b=b.concat(f.get()),void 0):(c.fn[d]&&(g=a["_"+d+"Options"]?a["_"+d+"Options"]("middle"):{classes:{}},a.element.find(e).each(function(){var e=c(this),f=e[d]("instance"),l=c.widget.extend({},
...
e),e.classes=a._resolveClassesValues(e.classes,c),c.element[c.widgetName](e)):a._updateCornerClass(b[e](),e)}),this._callChildMethod("refresh"))}});c.widget("ui.checkboxradio",[c.ui.formResetMixin,{version:"1.12.1",options:{disabled:null,label:null,icon:!0,classes:{"ui-checkboxradio-label":"ui-corner-all","ui-checkboxradio-icon":"ui-corner-all"}},_getCreateOptions:function(){var a,b,d=this,e=this._super()||{};return this._readType(),b=this.element.labels(),this.label=c(b[b.length-1]),this.label.length||
...
"items"===arguments[1]&&arguments[2]?this.controlgroup.apply(this,[arguments[0],"items.button",arguments[2]]):"option"===arguments[0]&&"items"===arguments[1]?this.controlgroup.apply(this,[arguments[0],"items.button"]):("object"==typeof arguments[0]&&arguments[0].items&&(arguments[0].items={button:arguments[0].items}),this.controlgroup.apply(this,arguments))});c.ui.button;c.extend(c.ui,{datepicker:{version:"1.12.1"}});var J;c.extend(x.prototype,{markerClassName:"hasDatepicker",maxRows:4,_widgetDatepicker:function(){return this.dpDiv},
setDefaults:function(a){return G(this._defaults,a||{}),this},_attachDatepicker:function(a,b){var d=a.nodeName.toLowerCase();var e="div"===d||"span"===d;a.id||(this.uuid+=1,a.id="dp"+this.uuid);var f=this._newInst(c(a),e);f.settings=c.extend({},b||{});"input"===d?this._connectDatepicker(a,f):e&&this._inlineDatepicker(a,f)},_newInst:function(a,b){return{id:a[0].id.replace(/([^A-Za-z0-9_\-])/g,"\\\\$1"),input:a,selectedDay:0,selectedMonth:0,selectedYear:0,drawMonth:0,drawYear:0,inline:b,dpDiv:b?z(c("\x3cdiv class\x3d'"+
...
c.data(a,"datepicker",b),this._setDate(b,this._getDefaultDate(b),!0),this._updateDatepicker(b),this._updateAlternate(b),b.settings.disabled&&this._disableDatepicker(a),b.dpDiv.css("display","block"))},_dialogDatepicker:function(a,b,d,e,f){var g,h,k,l,m;a=this._dialogInst;return a||(this.uuid+=1,g="dp"+this.uuid,this._dialogInput=c("\x3cinput type\x3d'text' id\x3d'"+g+"' style\x3d'position: absolute; top: -100px; width: 0px;'/\x3e"),this._dialogInput.on("keydown",this._doKeyDown),c("body").append(this._dialogInput),
a=this._dialogInst=this._newInst(this._dialogInput,!1),a.settings={},c.data(this._dialogInput[0],"datepicker",a)),G(a.settings,e||{}),b=b&&b.constructor===Date?this._formatDate(a,b):b,this._dialogInput.val(b),this._pos=f?f.length?f:[f.pageX,f.pageY]:null,this._pos||(h=document.documentElement.clientWidth,k=document.documentElement.clientHeight,l=document.documentElement.scrollLeft||document.body.scrollLeft,m=document.documentElement.scrollTop||document.body.scrollTop,this._pos=[h/2-100+l,k/2-150+
...
this._showDatepicker).off("keydown",this._doKeyDown).off("keypress",this._doKeyPress).off("keyup",this._doKeyUp)):("div"===b||"span"===b)&&d.removeClass(this.markerClassName).empty(),J===e&&(J=null))},_enableDatepicker:function(a){var b,d,e=c(a),f=c.data(a,"datepicker");e.hasClass(this.markerClassName)&&(b=a.nodeName.toLowerCase(),"input"===b?(a.disabled=!1,f.trigger.filter("button").each(function(){this.disabled=!1}).end().filter("img").css({opacity:"1.0",cursor:""})):("div"===b||"span"===b)&&(d=
e.children("."+this._inlineClass),d.children().removeClass("ui-state-disabled"),d.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled",!1)),this._disabledInputs=c.map(this._disabledInputs,function(b){return b===a?null:b}))},_disableDatepicker:function(a){var b,d,e=c(a),f=c.data(a,"datepicker");e.hasClass(this.markerClassName)&&(b=a.nodeName.toLowerCase(),"input"===b?(a.disabled=!0,f.trigger.filter("button").each(function(){this.disabled=!0}).end().filter("img").css({opacity:"0.5",
...
"datepicker")}catch(b){throw"Missing instance data for this datepicker";}},_optionDatepicker:function(a,b,d){var e,f,g,h,k=this._getInst(a);return 2===arguments.length&&"string"==typeof b?"defaults"===b?c.extend({},c.datepicker._defaults):k?"all"===b?c.extend({},k.settings):this._get(k,b):null:(e=b||{},"string"==typeof b&&(e={},e[b]=d),k&&(this._curInst===k&&this._hideDatepicker(),f=this._getDateDatepicker(a,!0),g=this._getMinMaxDate(k,"min"),h=this._getMinMaxDate(k,"max"),G(k.settings,e),null!==
...
!0),g&&c.datepicker._datepickerShowing&&c.datepicker._hideDatepicker(c.datepicker._curInst.input[0]));var h=(h=c.datepicker._get(g,"beforeShow"))?h.apply(a,[a,g]):{};!1!==h&&(G(g.settings,h),g.lastVal=null,c.datepicker._lastInput=a,c.datepicker._setDateFromField(g),c.datepicker._inDialog&&(a.value=""),c.datepicker._pos||(c.datepicker._pos=c.datepicker._findPos(a),c.datepicker._pos[1]+=a.offsetHeight),b=!1,c(a).parents().each(function(){return b|="fixed"===c(this).css("position"),!b}),d={left:c.datepicker._pos[0],
top:c.datepicker._pos[1]},c.datepicker._pos=null,g.dpDiv.empty(),g.dpDiv.css({position:"absolute",display:"block",top:"-1000px"}),c.datepicker._updateDatepicker(g),d=c.datepicker._checkOffset(g,d,b),g.dpDiv.css({position:c.datepicker._inDialog&&c.blockUI?"static":b?"fixed":"absolute",display:"none",left:d.left+"px",top:d.top+"px"}),g.inline||(e=c.datepicker._get(g,"showAnim"),f=c.datepicker._get(g,"duration"),g.dpDiv.css("z-index",r(c(a))+1),c.datepicker._datepickerShowing=!0,c.effects&&c.effects.effect[e]?
g.dpDiv.show(e,c.datepicker._get(g,"showOptions"),f):g.dpDiv[e||"show"](e?f:null),c.datepicker._shouldFocusInput(g)&&g.input.trigger("focus"),c.datepicker._curInst=g))}},_updateDatepicker:function(a){this.maxRows=4;J=a;a.dpDiv.empty().append(this._generateHTML(a));this._attachHandlers(a);var b,d=this._getNumberOfMonths(a),e=d[1],f=a.dpDiv.find("."+this._dayOverClass+" a");0<f.length&&A.apply(f.get(0));a.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");
...
c(document).scrollLeft():0,b.top-=d&&b.top===a.input.offset().top+h?c(document).scrollTop():0,b.left-=Math.min(b.left,b.left+e>k&&k>e?Math.abs(b.left+e-k):0),b.top-=Math.min(b.top,b.top+f>l&&l>f?Math.abs(f+h):0),b},_findPos:function(a){var b,d=this._getInst(a);for(d=this._get(d,"isRTL");a&&("hidden"===a.type||1!==a.nodeType||c.expr.filters.hidden(a));)a=a[d?"previousSibling":"nextSibling"];return b=c(a).offset(),[b.left,b.top]},_hideDatepicker:function(a){var b,d,e,f,g=this._curInst;!g||a&&g!==c.data(a,
...
return a.setDate(a.getDate()+4-(a.getDay()||7)),b=a.getTime(),a.setMonth(0),a.setDate(1),Math.floor(Math.round((b-a)/864E5)/7)+1},parseDate:function(a,b,d){if(null==a||null==b)throw"Invalid arguments";if(b="object"==typeof b?""+b:b+"",""===b)return null;var e,f,g,h=0,k=(d?d.shortYearCutoff:null)||this._defaults.shortYearCutoff;k="string"!=typeof k?k:(new Date).getFullYear()%100+parseInt(k,10);var l=(d?d.dayNamesShort:null)||this._defaults.dayNamesShort,m=(d?d.dayNames:null)||this._defaults.dayNames,
n=(d?d.monthNamesShort:null)||this._defaults.monthNamesShort;d=(d?d.monthNames:null)||this._defaults.monthNames;var p=-1,q=-1,u=-1,t=-1,v=!1,w=function(b){b=a.length>e+1&&a.charAt(e+1)===b;return b&&e++,b},D=function(a){var c=w(a);c="@"===a?14:"!"===a?20:"y"===a&&c?4:"o"===a?3:2;a=RegExp("^\\d{"+("y"===a?c:1)+","+c+"}");a=b.substring(h).match(a);if(!a)throw"Missing number at position "+h;return h+=a[0].length,parseInt(a[0],10)},E=function(a,d,e){var f=-1;a=c.map(w(a)?e:d,function(a,b){return[[b,a]]}).sort(function(a,
b){return-(a[1].length-b[1].length)});if(c.each(a,function(a,c){a=c[1];return b.substr(h,a.length).toLowerCase()===a.toLowerCase()?(f=c[0],h+=a.length,!1):void 0}),-1!==f)return f+1;throw"Unknown name at position "+h;},r=function(){if(b.charAt(h)!==a.charAt(e))throw"Unexpected literal at position "+h;h++};for(e=0;a.length>e;e++)if(v)"'"!==a.charAt(e)||w("'")?r():v=!1;else switch(a.charAt(e)){case "d":u=D("d");break;case "D":E("D",l,m);break;case "o":t=D("o");break;case "m":q=D("m");break;case "M":q=
E("M",n,d);break;case "y":p=D("y");break;case "@":var y=new Date(D("@"));p=y.getFullYear();q=y.getMonth()+1;u=y.getDate();break;case "!":y=new Date((D("!")-this._ticksTo1970)/1E4);p=y.getFullYear();q=y.getMonth()+1;u=y.getDate();break;case "'":w("'")?r():v=!0;break;default:r()}if(b.length>h&&(g=b.substr(h),!/^\s+/.test(g)))throw"Extra/unparsed characters found in date: "+g;if(-1===p?p=(new Date).getFullYear():100>p&&(p+=(new Date).getFullYear()-(new Date).getFullYear()%100+(k>=p?0:-100)),-1<t)for(q=
1,u=t;!(f=this._getDaysInMonth(p,q-1),f>=u);)q++,u-=f;if(y=this._daylightSavingAdjust(new Date(p,q-1,u)),y.getFullYear()!==p||y.getMonth()+1!==q||y.getDate()!==u)throw"Invalid date";return y},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*(718685+Math.floor(492.5)-Math.floor(19.7)+Math.floor(4.925)),formatDate:function(a,
b,c){if(!b)return"";var d,f=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort,g=(c?c.dayNames:null)||this._defaults.dayNames,h=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort;c=(c?c.monthNames:null)||this._defaults.monthNames;var k=function(b){b=a.length>d+1&&a.charAt(d+1)===b;return b&&d++,b},l=function(a,b,c){b=""+b;if(k(a))for(;c>b.length;)b="0"+b;return b},m=function(a,b,c,d){return k(a)?d[b]:c[b]},n="",p=!1;if(b)for(d=0;a.length>d;d++)if(p)"'"!==a.charAt(d)||k("'")?n+=a.charAt(d):
...
this._determineDate(a,this._get(a,"defaultDate"),new Date))},_determineDate:function(a,b,d){var e=function(a){var b=new Date;return b.setDate(b.getDate()+a),b},f=function(b){try{return c.datepicker.parseDate(c.datepicker._get(a,"dateFormat"),b,c.datepicker._getFormatConfig(a))}catch(p){}var d=(b.toLowerCase().match(/^c/)?c.datepicker._getDate(a):null)||new Date,e=d.getFullYear(),f=d.getMonth();d=d.getDate();for(var g=/([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g,n=g.exec(b);n;){switch(n[2]||"d"){case "d":case "D":d+=
parseInt(n[1],10);break;case "w":case "W":d+=7*parseInt(n[1],10);break;case "m":case "M":f+=parseInt(n[1],10);d=Math.min(d,c.datepicker._getDaysInMonth(e,f));break;case "y":case "Y":e+=parseInt(n[1],10),d=Math.min(d,c.datepicker._getDaysInMonth(e,f))}n=g.exec(b)}return new Date(e,f,d)};b=null==b||""===b?d:"string"==typeof b?f(b):"number"==typeof b?isNaN(b)?d:e(b):new Date(b.getTime());return b=b&&"Invalid Date"==""+b?d:b,b&&(b.setHours(0),b.setMinutes(0),b.setSeconds(0),b.setMilliseconds(0)),this._daylightSavingAdjust(b)},
...
selectDay:function(){return c.datepicker._selectDay(d,+this.getAttribute("data-month"),+this.getAttribute("data-year"),this),!1},selectMonth:function(){return c.datepicker._selectMonthYear(d,this,"M"),!1},selectYear:function(){return c.datepicker._selectMonthYear(d,this,"Y"),!1}}[this.getAttribute("data-handler")])})},_generateHTML:function(a){var b,c,e,f,g,h,k,l=new Date;l=this._daylightSavingAdjust(new Date(l.getFullYear(),l.getMonth(),l.getDate()));var m=this._get(a,"isRTL");var n=this._get(a,
"showButtonPanel");var p=this._get(a,"hideIfNoPrevNext");var q=this._get(a,"navigationAsDateFormat");var u=this._getNumberOfMonths(a),t=this._get(a,"showCurrentAtPos");var v=this._get(a,"stepMonths");var w=1!==u[0]||1!==u[1],D=this._daylightSavingAdjust(a.currentDay?new Date(a.currentYear,a.currentMonth,a.currentDay):new Date(9999,9,9)),E=this._getMinMaxDate(a,"min"),r=this._getMinMaxDate(a,"max");t=a.drawMonth-t;var y=a.drawYear;if(0>t&&(t+=12,y--),r){var B=this._daylightSavingAdjust(new Date(r.getFullYear(),
r.getMonth()-u[0]*u[1]+1,r.getDate()));for(B=E&&E>B?E:B;this._daylightSavingAdjust(new Date(y,t,1))>B;)t--,0>t&&(t=11,y--)}a.drawMonth=t;a.drawYear=y;B=this._get(a,"prevText");B=q?this.formatDate(B,this._daylightSavingAdjust(new Date(y,t-v,1)),this._getFormatConfig(a)):B;B=this._canAdjustMonth(a,-1,y,t)?"\x3ca class\x3d'ui-datepicker-prev ui-corner-all' data-handler\x3d'prev' data-event\x3d'click' title\x3d'"+B+"'\x3e\x3cspan class\x3d'ui-icon ui-icon-circle-triangle-"+(m?"e":"w")+"'\x3e"+B+"\x3c/span\x3e\x3c/a\x3e":
p?"":"\x3ca class\x3d'ui-datepicker-prev ui-corner-all ui-state-disabled' title\x3d'"+B+"'\x3e\x3cspan class\x3d'ui-icon ui-icon-circle-triangle-"+(m?"e":"w")+"'\x3e"+B+"\x3c/span\x3e\x3c/a\x3e";var F=this._get(a,"nextText");F=q?this.formatDate(F,this._daylightSavingAdjust(new Date(y,t+v,1)),this._getFormatConfig(a)):F;p=this._canAdjustMonth(a,1,y,t)?"\x3ca class\x3d'ui-datepicker-next ui-corner-all' data-handler\x3d'next' data-event\x3d'click' title\x3d'"+F+"'\x3e\x3cspan class\x3d'ui-icon ui-icon-circle-triangle-"+
(m?"w":"e")+"'\x3e"+F+"\x3c/span\x3e\x3c/a\x3e":p?"":"\x3ca class\x3d'ui-datepicker-next ui-corner-all ui-state-disabled' title\x3d'"+F+"'\x3e\x3cspan class\x3d'ui-icon ui-icon-circle-triangle-"+(m?"w":"e")+"'\x3e"+F+"\x3c/span\x3e\x3c/a\x3e";v=this._get(a,"currentText");F=this._get(a,"gotoCurrent")&&a.currentDay?D:l;v=q?this.formatDate(v,F,this._getFormatConfig(a)):v;q=a.inline?"":"\x3cbutton type\x3d'button' class\x3d'ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler\x3d'hide' data-event\x3d'click'\x3e"+
this._get(a,"closeText")+"\x3c/button\x3e";n=n?"\x3cdiv class\x3d'ui-datepicker-buttonpane ui-widget-content'\x3e"+(m?q:"")+(this._isInRange(a,F)?"\x3cbutton type\x3d'button' class\x3d'ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler\x3d'today' data-event\x3d'click'\x3e"+v+"\x3c/button\x3e":"")+(m?"":q)+"\x3c/div\x3e":"";q=parseInt(this._get(a,"firstDay"),10);q=isNaN(q)?0:q;v=this._get(a,"showWeek");F=this._get(a,"dayNames");var R=this._get(a,"dayNamesMin");
var x=this._get(a,"monthNames");var z=this._get(a,"monthNamesShort");var A=this._get(a,"beforeShowDay");var G=this._get(a,"showOtherMonths");var J=this._get(a,"selectOtherMonths");var I=this._getDefaultDate(a);var K="";for(c=0;u[0]>c;c++){var L="";this.maxRows=4;for(e=0;u[1]>e;e++){if(f=this._daylightSavingAdjust(new Date(y,t,a.selectedDay)),b=" ui-corner-all",g="",w){if(g+="\x3cdiv class\x3d'ui-datepicker-group",1<u[1])switch(e){case 0:g+=" ui-datepicker-group-first";b=" ui-corner-"+(m?"right":"left");
break;case u[1]-1:g+=" ui-datepicker-group-last";b=" ui-corner-"+(m?"left":"right");break;default:g+=" ui-datepicker-group-middle",b=""}g+="'\x3e"}g+="\x3cdiv class\x3d'ui-datepicker-header ui-widget-header ui-helper-clearfix"+b+"'\x3e"+(/all|left/.test(b)&&0===c?m?p:B:"")+(/all|right/.test(b)&&0===c?m?B:p:"")+this._generateMonthYearHeader(a,t,y,E,r,0<c||0<e,x,z)+"\x3c/div\x3e\x3ctable class\x3d'ui-datepicker-calendar'\x3e\x3cthead\x3e\x3ctr\x3e";var H=v?"\x3cth class\x3d'ui-datepicker-week-col'\x3e"+
this._get(a,"weekHeader")+"\x3c/th\x3e":"";for(b=0;7>b;b++){var C=(b+q)%7;H+="\x3cth scope\x3d'col'"+(5<=(b+q+6)%7?" class\x3d'ui-datepicker-week-end'":"")+"\x3e\x3cspan title\x3d'"+F[C]+"'\x3e"+R[C]+"\x3c/span\x3e\x3c/th\x3e"}g+=H+"\x3c/tr\x3e\x3c/thead\x3e\x3ctbody\x3e";H=this._getDaysInMonth(y,t);y===a.selectedYear&&t===a.selectedMonth&&(a.selectedDay=Math.min(a.selectedDay,H));b=(this._getFirstDayOfMonth(y,t)-q+7)%7;H=Math.ceil((b+H)/7);this.maxRows=H=w?this.maxRows>H?this.maxRows:H:H;C=this._daylightSavingAdjust(new Date(y,
t,1-b));for(h=0;H>h;h++){g+="\x3ctr\x3e";var M=v?"\x3ctd class\x3d'ui-datepicker-week-col'\x3e"+this._get(a,"calculateWeek")(C)+"\x3c/td\x3e":"";for(b=0;7>b;b++){var N=A?A.apply(a.input?a.input[0]:null,[C]):[!0,""];var O=(k=C.getMonth()!==t)&&!J||!N[0]||E&&E>C||r&&C>r;M+="\x3ctd class\x3d'"+(5<=(b+q+6)%7?" ui-datepicker-week-end":"")+(k?" ui-datepicker-other-month":"")+(C.getTime()===f.getTime()&&t===a.selectedMonth&&a._keyEvent||I.getTime()===C.getTime()&&I.getTime()===f.getTime()?" "+this._dayOverClass:
"")+(O?" "+this._unselectableClass+" ui-state-disabled":"")+(k&&!G?"":" "+N[1]+(C.getTime()===D.getTime()?" "+this._currentClass:"")+(C.getTime()===l.getTime()?" ui-datepicker-today":""))+"'"+(k&&!G||!N[2]?"":" title\x3d'"+N[2].replace(/'/g,"\x26#39;")+"'")+(O?"":" data-handler\x3d'selectDay' data-event\x3d'click' data-month\x3d'"+C.getMonth()+"' data-year\x3d'"+C.getFullYear()+"'")+"\x3e"+(k&&!G?"\x26#xa0;":O?"\x3cspan class\x3d'ui-state-default'\x3e"+C.getDate()+"\x3c/span\x3e":"\x3ca class\x3d'ui-state-default"+
(C.getTime()===l.getTime()?" ui-state-highlight":"")+(C.getTime()===D.getTime()?" ui-state-active":"")+(k?" ui-priority-secondary":"")+"' href\x3d'#'\x3e"+C.getDate()+"\x3c/a\x3e")+"\x3c/td\x3e";C.setDate(C.getDate()+1);C=this._daylightSavingAdjust(C)}g+=M+"\x3c/tr\x3e"}t++;11<t&&(t=0,y++);g+="\x3c/tbody\x3e\x3c/table\x3e"+(w?"\x3c/div\x3e"+(0<u[0]&&e===u[1]-1?"\x3cdiv class\x3d'ui-datepicker-row-break'\x3e\x3c/div\x3e":""):"");L+=g}K+=L}return K+=n,a._keyEvent=!1,K},_generateMonthYearHeader:function(a,
b,c,e,f,g,h,k){var d,m=this._get(a,"changeMonth"),n=this._get(a,"changeYear"),p=this._get(a,"showMonthAfterYear"),q="\x3cdiv class\x3d'ui-datepicker-title'\x3e",u="";if(g||!m)u+="\x3cspan class\x3d'ui-datepicker-month'\x3e"+h[b]+"\x3c/span\x3e";else{h=e&&e.getFullYear()===c;var t=f&&f.getFullYear()===c;u+="\x3cselect class\x3d'ui-datepicker-month' data-handler\x3d'selectMonth' data-event\x3d'change'\x3e";for(d=0;12>d;d++)(!h||d>=e.getMonth())&&(!t||f.getMonth()>=d)&&(u+="\x3coption value\x3d'"+d+
"'"+(d===b?" selected\x3d'selected'":"")+"\x3e"+k[d]+"\x3c/option\x3e");u+="\x3c/select\x3e"}if(p||(q+=u+(!g&&m&&n?"":"\x26#xa0;")),!a.yearshtml)if(a.yearshtml="",g||!n)q+="\x3cspan class\x3d'ui-datepicker-year'\x3e"+c+"\x3c/span\x3e";else{k=this._get(a,"yearRange").split(":");var v=(new Date).getFullYear();h=function(a){a=a.match(/c[+\-].*/)?c+parseInt(a.substring(1),10):a.match(/[+\-].*/)?v+parseInt(a,10):parseInt(a,10);return isNaN(a)?v:a};b=h(k[0]);k=Math.max(b,h(k[1]||""));b=e?Math.max(b,e.getFullYear()):
b;k=f?Math.min(k,f.getFullYear()):k;for(a.yearshtml+="\x3cselect class\x3d'ui-datepicker-year' data-handler\x3d'selectYear' data-event\x3d'change'\x3e";k>=b;b++)a.yearshtml+="\x3coption value\x3d'"+b+"'"+(b===c?" selected\x3d'selected'":"")+"\x3e"+b+"\x3c/option\x3e";a.yearshtml+="\x3c/select\x3e";q+=a.yearshtml;a.yearshtml=null}return q+=this._get(a,"yearSuffix"),p&&(q+=(!g&&m&&n?"":"\x26#xa0;")+u),q+="\x3c/div\x3e"},_adjustInstDate:function(a,b,c){var d=a.selectedYear+("Y"===c?b:0),f=a.selectedMonth+
...
a&&"getDate"!==a&&"widget"!==a?"option"===a&&2===arguments.length&&"string"==typeof arguments[1]?c.datepicker["_"+a+"Datepicker"].apply(c.datepicker,[this[0]].concat(b)):this.each(function(){"string"==typeof a?c.datepicker["_"+a+"Datepicker"].apply(c.datepicker,[this].concat(b)):c.datepicker._attachDatepicker(this,a)}):c.datepicker["_"+a+"Datepicker"].apply(c.datepicker,[this[0]].concat(b))};c.datepicker=new x;c.datepicker.initialized=!1;c.datepicker.uuid=(new Date).getTime();c.datepicker.version=
...
this.options.position))},close:function(a){this.isOpen&&(this.isOpen=!1,this._toggleAttr(),this.range=null,this._off(this.document),this._trigger("close",a))},widget:function(){return this.button},menuWidget:function(){return this.menu},_renderButtonItem:function(a){var b=c("\x3cspan\x3e");return this._setText(b,a.label),this._addClass(b,"ui-selectmenu-text"),b},_renderMenu:function(a,b){var d=this,e="";c.each(b,function(b,g){var f;g.optgroup!==e&&(f=c("\x3cli\x3e",{text:g.optgroup}),d._addClass(f,
"ui-selectmenu-optgroup","ui-menu-divider"+(g.element.parent("optgroup").prop("disabled")?" ui-state-disabled":"")),f.appendTo(a),e=g.optgroup);d._renderItemData(a,g)})},_renderItemData:function(a,b){return this._renderItem(a,b).data("ui-selectmenu-item",b)},_renderItem:function(a,b){var d=c("\x3cli\x3e"),e=c("\x3cdiv\x3e",{title:b.element.attr("title")});return b.disabled&&this._addClass(d,null,"ui-state-disabled"),this._setText(e,b.label),d.append(e).appendTo(a)},_setText:function(a,b){b?a.text(b):
...
this._createHandles();this._setupEvents();this._refreshValue()},_createHandles:function(){var a=this.options;var b=this.element.find(".ui-slider-handle"),d=[];var e=a.values&&a.values.length||1;b.length>e&&(b.slice(e).remove(),b=b.slice(0,e));for(a=b.length;e>a;a++)d.push("\x3cspan tabindex\x3d'0'\x3e\x3c/span\x3e");this.handles=b.add(c(d.join("")).appendTo(this.element));this._addClass(this.handles,"ui-slider-handle","ui-state-default");this.handle=this.handles.eq(0);this.handles.each(function(a){c(this).data("ui-slider-handle-index",
a).attr("tabIndex",0)})},_createRange:function(){var a=this.options;a.range?(!0===a.range&&(a.values?a.values.length&&2!==a.values.length?a.values=[a.values[0],a.values[0]]:c.isArray(a.values)&&(a.values=a.values.slice(0)):a.values=[this._valueMin(),this._valueMin()]),this.range&&this.range.length?(this._removeClass(this.range,"ui-slider-range-min ui-slider-range-max"),this.range.css({left:"",bottom:""})):(this.range=c("\x3cdiv\x3e").appendTo(this.element),this._addClass(this.range,"ui-slider-range")),
("min"===a.range||"max"===a.range)&&this._addClass(this.range,"ui-slider-range-"+a.range)):(this.range&&this.range.remove(),this.range=null)},_setupEvents:function(){this._off(this.handles);this._on(this.handles,this._handleEvents);this._hoverable(this.handles);this._focusable(this.handles)},_destroy:function(){this.handles.remove();this.range&&this.range.remove();this._mouseDestroy()},_mouseCapture:function(a){var b,d,e,f,g,h,k,l,m=this,n=this.options;return n.disabled?!1:(this.elementSize={width:this.element.outerWidth(),
...
this._toggleClass(this.uiSpinner,null,"ui-state-disabled",!!a);this.element.prop("disabled",!!a);this.buttons.button(a?"disable":"enable")},_setOptions:I(function(a){this._super(a)}),_parse:function(a){return"string"==typeof a&&""!==a&&(a=window.Globalize&&this.options.numberFormat?Globalize.parseFloat(a,10,this.options.culture):+a),""===a||isNaN(a)?null:a},_format:function(a){return""===a?"":window.Globalize&&this.options.numberFormat?Globalize.format(a,this.options.numberFormat,this.options.culture):
a},_refresh:function(){this.element.attr({"aria-valuemin":this.options.min,"aria-valuemax":this.options.max,"aria-valuenow":this._parse(this.element.val())})},isValid:function(){var a=this.value();return null===a?!1:a===this._adjustValue(a)},_value:function(a,b){var c;""!==a&&(c=this._parse(a),null!==c&&(b||(c=this._adjustValue(c)),a=this._format(c)));this.element.val(a);this._refresh()},_destroy:function(){this.element.prop("disabled",!1).removeAttr("autocomplete role aria-valuemin aria-valuemax aria-valuenow");
this.uiSpinner.replaceWith(this.element)},stepUp:I(function(a){this._stepUp(a)}),_stepUp:function(a){this._start()&&(this._spin((a||1)*this.options.step),this._stop())},stepDown:I(function(a){this._stepDown(a)}),_stepDown:function(a){this._start()&&(this._spin((a||1)*-this.options.step),this._stop())},pageUp:I(function(a){this._stepUp((a||1)*this.options.page)}),pageDown:I(function(a){this._stepDown((a||1)*this.options.page)}),value:function(a){return arguments.length?(I(this._value).call(this,a),
...
!1;this._addClass("ui-tabs","ui-widget ui-widget-content");this._toggleClass("ui-tabs-collapsible",null,b.collapsible);this._processTabs();b.active=this._initialActive();c.isArray(b.disabled)&&(b.disabled=c.unique(b.disabled.concat(c.map(this.tabs.filter(".ui-state-disabled"),function(b){return a.tabs.index(b)}))).sort());this.active=!1!==this.options.active&&this.anchors.length?this._findActive(b.active):c();this._refresh();this.active.length&&this.load(b.active)},_initialActive:function(){var a=
...
"tablist");this._addClass(this.tablist,"ui-tabs-nav","ui-helper-reset ui-helper-clearfix ui-widget-header");this.tablist.on("mousedown"+this.eventNamespace,"\x3e li",function(a){c(this).is(".ui-state-disabled")&&a.preventDefault()}).on("focus"+this.eventNamespace,".ui-tabs-anchor",function(){c(this).closest("li").is(".ui-state-disabled")&&this.blur()});this.tabs=this.tablist.find("\x3e li:has(a[href])").attr({role:"tab",tabIndex:-1});this._addClass(this.tabs,"ui-tabs-tab","ui-state-default");this.anchors=
this.tabs.map(function(){return c("a",this)[0]}).attr({role:"presentation",tabIndex:-1});this._addClass(this.anchors,"ui-tabs-anchor");this.panels=c();this.anchors.each(function(b,d){var e,f,g,m=c(d).uniqueId().attr("id"),n=c(d).closest("li"),p=n.attr("aria-controls");a._isLocal(d)?(e=d.hash,g=e.substring(1),f=a.element.find(a._sanitizeSelector(e))):(g=n.attr("aria-controls")||c({}).uniqueId()[0].id,e="#"+g,f=a.element.find(e),f.length||(f=a._createPanel(g),f.insertAfter(a.panels[b-1]||a.tablist)),
f.attr("aria-live","polite"));f.length&&(a.panels=a.panels.add(f));p&&n.data("ui-tabs-aria-controls",p);n.attr({"aria-controls":g,"aria-labelledby":m});f.attr("aria-labelledby",m)});this.panels.attr("role","tabpanel");this._addClass(this.panels,"ui-tabs-panel","ui-widget-content");b&&(this._off(b.not(this.tabs)),this._off(d.not(this.anchors)),this._off(e.not(this.panels)))},_getList:function(){return this.tablist||this.element.find("ol, ul").eq(0)},_createPanel:function(a){return c("\x3cdiv\x3e").attr("id",
...
b,g)),this.xhr&&"canceled"!==this.xhr.statusText&&(this._addClass(e,"ui-tabs-loading"),f.attr("aria-busy","true"),this.xhr.done(function(a,c,e){setTimeout(function(){f.html(a);d._trigger("load",b,g);h(e,c)},1)}).fail(function(a,b){setTimeout(function(){h(a,b)},1)})))},_ajaxSettings:function(a,b,d){var e=this;return{url:a.attr("href").replace(/#.*$/,""),beforeSend:function(a,g){return e._trigger("beforeLoad",b,c.extend({jqXHR:a,ajaxSettings:g},d))}}},_getPanelForTab:function(a){a=c(a).attr("aria-controls");
...
e(a)):k.position(c.extend({of:b},this.options.position));k.hide();this._show(k,this.options.show);this.options.track&&this.options.show&&this.options.show.delay&&(g=this.delayedShow=setInterval(function(){k.is(":visible")&&(e(h.of),clearInterval(g))},c.fx.interval));this._trigger("open",a,{tooltip:k})}},_registerCloseHandlers:function(a,b){var d={keyup:function(a){a.keyCode===c.ui.keyCode.ESCAPE&&(a=c.Event(a),a.currentTarget=b[0],this.close(a,!0))}};b[0]!==this.element[0]&&(d.remove=function(){this._removeTooltip(this._find(b).tooltip)});
...
"mouseleave focusout keyup"),e[0]!==this.element[0]&&this._off(e,"remove"),this._off(this.document,"mousemove"),a&&"mouseleave"===a.type&&c.each(this.parents,function(a,b){c(b.element).attr("title",b.title);delete d.parents[a]}),f.closing=!0,this._trigger("close",a,{tooltip:b}),f.hiding||(f.closing=!1)),void 0):(e.removeData("ui-tooltip-open"),void 0)},_tooltip:function(a){var b=c("\x3cdiv\x3e").attr("role","tooltip"),d=c("\x3cdiv\x3e").appendTo(b),e=b.uniqueId().attr("id");return this._addClass(d,
...
e.target=e.currentTarget=d[0];a.close(e,!0);c("#"+b).remove();d.data("ui-tooltip-title")&&(d.attr("title")||d.attr("title",d.data("ui-tooltip-title")),d.removeData("ui-tooltip-title"))});this.liveRegion.remove()}});!1!==c.uiBackCompat&&c.widget("ui.tooltip",c.ui.tooltip,{options:{tooltipClass:null},_tooltip:function(){var a=this._superApply(arguments);return this.options.tooltipClass&&a.tooltip.addClass(this.options.tooltipClass),a}});c.ui.tooltip;c.effects={effect:{}};(function(a,b){function c(a,
b,c){var d=m[b.type]||{};return null==a?c||!b.def?null:b.def:(a=d.floor?~~a:parseFloat(a),isNaN(a)?b.def:d.mod?(a+d.mod)%d.mod:0>a?0:a>d.max?d.max:a)}function e(c){var d=k(),e=d._rgba=[];return c=c.toLowerCase(),q(h,function(a,f){var g;a=(a=f.re.exec(c))&&f.parse(a);f=f.space||"rgba";return a?(g=d[f](a),d[l[f].cache]=g[l[f].cache],e=d._rgba=g._rgba,!1):b}),e.length?("0,0,0,0"===e.join()&&a.extend(e,u.transparent),d):u[c]}function f(a,b,c){return c=(c+1)%1,1>6*c?a+6*(b-a)*c:1>2*c?b:2>3*c?a+6*(b-a)*
(2/3-c):a}var g=/^([\-+])=\s*(\d+\.?\d*)/,h=[{re:/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(a){return[a[1],a[2],a[3],a[4]]}},{re:/rgba?\(\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(a){return[2.55*a[1],2.55*a[2],2.55*a[3],a[4]]}},{re:/#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})/,parse:function(a){return[parseInt(a[1],16),parseInt(a[2],16),parseInt(a[3],16)]}},{re:/#([a-f0-9])([a-f0-9])([a-f0-9])/,
parse:function(a){return[parseInt(a[1]+a[1],16),parseInt(a[2]+a[2],16),parseInt(a[3]+a[3],16)]}},{re:/hsla?\(\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,space:"hsla",parse:function(a){return[a[1],a[2]/100,a[3]/100,a[4]]}}],k=a.Color=function(b,c,d,e){return new a.Color.fn.parse(b,c,d,e)},l={rgba:{props:{red:{idx:0,type:"byte"},green:{idx:1,type:"byte"},blue:{idx:2,type:"byte"}}},hsla:{props:{hue:{idx:0,type:"degrees"},saturation:{idx:1,type:"percent"},
lightness:{idx:2,type:"percent"}}}},m={"byte":{floor:!0,max:255},percent:{max:1},degrees:{mod:360,floor:!0}},n=k.support={},p=a("\x3cp\x3e")[0],q=a.each;p.style.cssText="background-color:rgba(1,1,1,.5)";n.rgba=-1<p.style.backgroundColor.indexOf("rgba");q(l,function(a,b){b.cache="_"+a;b.props.alpha={idx:3,type:"percent",def:1}});k.fn=a.extend(k.prototype,{parse:function(d,f,g,h){if(d===b)return this._rgba=[null,null,null,null],this;(d.jquery||d.nodeType)&&(d=a(d).css(f),f=b);var m=this,n=a.type(d),
t=this._rgba=[];return f!==b&&(d=[d,f,g,h],n="array"),"string"===n?this.parse(e(d)||u._default):"array"===n?(q(l.rgba.props,function(a,b){t[b.idx]=c(d[b.idx],b)}),this):"object"===n?(d instanceof k?q(l,function(a,b){d[b.cache]&&(m[b.cache]=d[b.cache].slice())}):q(l,function(b,e){var f=e.cache;q(e.props,function(a,b){if(!m[f]&&e.to){if("alpha"===a||null==d[a])return;m[f]=e.to(m._rgba)}m[f][b.idx]=c(d[a],b,!0)});m[f]&&0>a.inArray(null,m[f].slice(0,3))&&(m[f][3]=1,e.from&&(m._rgba=e.from(m[f])))}),this):
b},is:function(a){var c=k(a),d=!0,e=this;return q(l,function(a,f){var g,h=c[f.cache];return h&&(g=e[f.cache]||f.to&&f.to(e._rgba)||[],q(f.props,function(a,c){return null!=h[c.idx]?d=h[c.idx]===g[c.idx]:b})),d}),d},_space:function(){var a=[],b=this;return q(l,function(c,d){b[d.cache]&&a.push(c)}),a.pop()},transition:function(a,b){var d=k(a);a=d._space();var e=l[a],f=0===this.alpha()?k("transparent"):this,g=f[e.cache]||e.to(f._rgba),h=g.slice();return d=d[e.cache],q(e.props,function(a,e){a=e.idx;var f=
g[a],k=d[a],l=m[e.type]||{};null!==k&&(null===f?h[a]=k:(l.mod&&(k-f>l.mod/2?f+=l.mod:f-k>l.mod/2&&(f-=l.mod)),h[a]=c((k-f)*b+f,e)))}),this[a](h)},blend:function(b){if(1===this._rgba[3])return this;var c=this._rgba.slice(),d=c.pop(),e=k(b)._rgba;return k(a.map(c,function(a,b){return(1-d)*e[b]+d*a}))},toRgbaString:function(){var b="rgba(",c=a.map(this._rgba,function(a,b){return null==a?2<b?1:0:a});return 1===c[3]&&(c.pop(),b="rgb("),b+c.join()+")"},toHslaString:function(){var b="hsla(",c=a.map(this.hsla(),
function(a,b){return null==a&&(a=2<b?1:0),b&&3>b&&(a=Math.round(100*a)+"%"),a});return 1===c[3]&&(c.pop(),b="hsl("),b+c.join()+")"},toHexString:function(b){var c=this._rgba.slice(),d=c.pop();return b&&c.push(~~(255*d)),"#"+a.map(c,function(a){return a=(a||0).toString(16),1===a.length?"0"+a:a}).join("")},toString:function(){return 0===this._rgba[3]?"transparent":this.toRgbaString()}});k.fn.parse.prototype=k.fn;l.hsla.to=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];
...
function(d,e){var f=e.props,h=e.cache,l=e.to,m=e.from;k.fn[d]=function(d){if(l&&!this[h]&&(this[h]=l(this._rgba)),d===b)return this[h].slice();var e,g=a.type(d),n="array"===g||"object"===g?d:arguments,p=this[h].slice();return q(f,function(a,b){a=n["object"===g?a:b.idx];null==a&&(a=p[b.idx]);p[b.idx]=c(a,b)}),m?(e=k(m(p)),e[h]=p,e):k(p)};q(f,function(b,c){k.fn[b]||(k.fn[b]=function(e){var f,h=a.type(e),k="alpha"===b?this._hsla?"hsla":"rgba":d,l=this[k](),m=l[c.idx];return"undefined"===h?m:("function"===
h&&(e=e.call(this,m),h=a.type(e)),null==e&&c.empty?this:("string"===h&&(f=g.exec(e),f&&(e=m+parseFloat(f[2])*("+"===f[1]?1:-1))),l[c.idx]=e,this[k](l)))})})});k.hook=function(b){b=b.split(" ");q(b,function(b,c){a.cssHooks[c]={set:function(b,d){var f,g="";if("transparent"!==d&&("string"!==a.type(d)||(f=e(d)))){if(d=k(f||d),!n.rgba&&1!==d._rgba[3]){for(f="backgroundColor"===c?b.parentNode:b;(""===g||"transparent"===g)&&f&&f.style;)try{g=a.css(f,"backgroundColor"),f=f.parentNode}catch(B){}d=d.blend(g&&
"transparent"!==g?g:"_default")}d=d.toRgbaString()}try{b.style[c]=d}catch(B){}}};a.fx.step[c]=function(b){b.colorInit||(b.start=k(b.elem,c),b.end=k(b.end),b.colorInit=!0);a.cssHooks[c].set(b.elem,b.start.transition(b.end,b.pos))}})};k.hook("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor");a.cssHooks.borderColor={expand:function(a){var b={};return q(["Top","Right","Bottom","Left"],function(c,
d){b["border"+d+"Color"]=a}),b}};var u=a.Color.names={aqua:"#00ffff",black:"#000000",blue:"#0000ff",fuchsia:"#ff00ff",gray:"#808080",green:"#008000",lime:"#00ff00",maroon:"#800000",navy:"#000080",olive:"#808000",purple:"#800080",red:"#ff0000",silver:"#c0c0c0",teal:"#008080",white:"#ffffff",yellow:"#ffff00",transparent:[null,null,null,0],_default:"#ffffff"}})(c);(function(){function a(a){var b=a.ownerDocument.defaultView?a.ownerDocument.defaultView.getComputedStyle(a,null):a.currentStyle,d={};if(b&&
b.length&&b[0]&&b[b[0]])for(a=b.length;a--;){var e=b[a];"string"==typeof b[e]&&(d[c.camelCase(e)]=b[e])}else for(e in b)"string"==typeof b[e]&&(d[e]=b[e]);return d}var b=["add","remove","toggle"],d={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};c.each(["borderLeftStyle","borderRightStyle","borderBottomStyle","borderTopStyle"],function(a,b){c.fx.step[b]=function(a){("none"!==a.end&&!a.setAttr||1===a.pos&&!a.setAttr)&&(c.style(a.elem,
b,a.end),a.setAttr=!0)}});c.fn.addBack||(c.fn.addBack=function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))});c.effects.animateClass=function(e,f,g,h){var k=c.speed(f,g,h);return this.queue(function(){var f=c(this),g=f.attr("class")||"",h=k.children?f.find("*").addBack():f;h=h.map(function(){return{el:c(this),start:a(this)}});var p=function(){c.each(b,function(a,b){e[b]&&f[b+"Class"](e[b])})};p();h=h.map(function(){this.end=a(this.el[0]);var b=this.start,e=this.end,f,g={};
for(f in e){var h=e[f];b[f]!==h&&(d[f]||(c.fx.step[f]||!isNaN(parseFloat(h)))&&(g[f]=h))}return this.diff=g,this});f.attr("class",g);h=h.map(function(){var a=this,b=c.Deferred(),d=c.extend({},k,{queue:!1,complete:function(){b.resolve(a)}});return this.el.animate(this.diff,d),b.promise()});c.when.apply(c,h.get()).done(function(){p();c.each(arguments,function(){var a=this.el;c.each(this.diff,function(b){a.css(b,"")})});k.complete.call(f[0])})})};c.fn.extend({addClass:function(a){return function(b,d,
e,k){return d?c.effects.animateClass.call(this,{add:b},d,e,k):a.apply(this,arguments)}}(c.fn.addClass),removeClass:function(a){return function(b,d,e,k){return 1<arguments.length?c.effects.animateClass.call(this,{remove:b},d,e,k):a.apply(this,arguments)}}(c.fn.removeClass),toggleClass:function(a){return function(b,d,e,k,l){return"boolean"==typeof d||void 0===d?e?c.effects.animateClass.call(this,d?{add:b}:{remove:b},e,k,l):a.apply(this,arguments):c.effects.animateClass.call(this,{toggle:b},d,e,k)}}(c.fn.toggleClass),
...
h=e.css(p);k||(k=e["top"===p?"outerHeight":"outerWidth"]()/3);f&&(d={opacity:1},d[p]=h,e.css("opacity",0).css(p,q?2*-k:2*k).animate(d,n,a));g&&(k/=Math.pow(2,l-1));d={};for(d[p]=h;l>r;r++){var v={};v[p]=(q?"-\x3d":"+\x3d")+k;e.animate(v,n,a).animate(d,n,a);k=g?2*k:k/2}g&&(v={opacity:0},v[p]=(q?"-\x3d":"+\x3d")+k,e.animate(v,n,a));e.queue(b);c.effects.unshift(e,t,m+1)});c.effects.define("clip","hide",function(a,b){var d={},e=c(this);var f=a.direction||"vertical";var g="both"===f,h=g||"horizontal"===
...
"+\x3d",k="+\x3d"===h?"-\x3d":"+\x3d",l={opacity:0};c.effects.createPlaceholder(d);f=a.distance||d["top"===g?"outerHeight":"outerWidth"](!0)/2;l[g]=h+f;e&&(d.css(l),l[g]=k+f,l.opacity=1);d.animate(l,{queue:!1,duration:a.duration,easing:a.easing,complete:b})});c.effects.define("explode","hide",function(a,b){function d(){q.push(this);q.length===g*h&&(k.css({visibility:"visible"}),c(q).remove(),b())}var e,f,g=a.pieces?Math.round(Math.sqrt(a.pieces)):3,h=g,k=c(this),l="show"===a.mode,m=k.show().css("visibility",
"hidden").offset(),n=Math.ceil(k.outerWidth()/h),p=Math.ceil(k.outerHeight()/g),q=[];for(e=0;g>e;e++){var r=m.top+e*p;var t=e-(g-1)/2;for(f=0;h>f;f++){var v=m.left+f*n;var w=f-(h-1)/2;k.clone().appendTo("body").wrap("\x3cdiv\x3e\x3c/div\x3e").css({position:"absolute",visibility:"visible",left:-f*n,top:-e*p}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:n,height:p,left:v+(l?w*n:0),top:r+(l?t*p:0),opacity:l?0:1}).animate({left:v+(l?0:w*n),top:r+(l?0:t*p),
opacity:l?1:0},a.duration||500,a.easing,d)}}});c.effects.define("fade","toggle",function(a,b){var d="show"===a.mode;c(this).css("opacity",d?0:1).animate({opacity:d?1:0},{queue:!1,duration:a.duration,easing:a.easing,complete:b})});c.effects.define("fold","hide",function(a,b){var d=c(this),e=a.mode,f="show"===e;e="hide"===e;var g=a.size||15,h=/([0-9]+)%/.exec(g),k=a.horizFirst?["right","bottom"]:["bottom","right"],l=a.duration/2,m=c.effects.createPlaceholder(d),n=d.cssClip(),p={clip:c.extend({},n)},
q={clip:c.extend({},n)},r=[n[k[0]],n[k[1]]],t=d.queue().length;h&&(g=parseInt(h[1],10)/100*r[e?0:1]);p.clip[k[0]]=g;q.clip[k[0]]=g;q.clip[k[1]]=0;f&&(d.cssClip(q.clip),m&&m.css(c.effects.clipToBox(q)),q.clip=n);d.queue(function(b){m&&m.animate(c.effects.clipToBox(p),l,a.easing).animate(c.effects.clipToBox(q),l,a.easing);b()}).animate(p,l,a.easing).animate(q,l,a.easing).queue(b);c.effects.unshift(d,t,4)});c.effects.define("highlight","show",function(a,b){var d=c(this),e={backgroundColor:d.css("backgroundColor")};
"hide"===a.mode&&(e.opacity=0);c.effects.saveStyle(d);d.css({backgroundImage:"none",backgroundColor:a.color||"#ffff99"}).animate(e,{queue:!1,duration:a.duration,easing:a.easing,complete:b})});c.effects.define("size",function(a,b){var d,e,f=c(this),g=["fontSize"],h=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],k=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],l=a.mode,m="effect"!==l,n=a.scale||"both",p=a.origin||["middle","center"],q=f.css("position"),r=f.position(),
t=c.effects.scaledDimensions(f),v=a.from||t,w=a.to||c.effects.scaledDimensions(f,0);c.effects.createPlaceholder(f);"show"===l&&(e=v,v=w,w=e);var x=v.height/t.height;var z=v.width/t.width;var A=w.height/t.height;var y=w.width/t.width;("box"===n||"both"===n)&&(x!==A&&(v=c.effects.setTransition(f,h,x,v),w=c.effects.setTransition(f,h,A,w)),z!==y&&(v=c.effects.setTransition(f,k,z,v),w=c.effects.setTransition(f,k,y,w)));("content"===n||"both"===n)&&x!==A&&(v=c.effects.setTransition(f,g,x,v),w=c.effects.setTransition(f,
g,A,w));p&&(d=c.effects.getBaseline(p,t),v.top=(t.outerHeight-v.outerHeight)*d.y+r.top,v.left=(t.outerWidth-v.outerWidth)*d.x+r.left,w.top=(t.outerHeight-w.outerHeight)*d.y+r.top,w.left=(t.outerWidth-w.outerWidth)*d.x+r.left);f.css(v);"content"!==n&&"both"!==n||(h=h.concat(["marginTop","marginBottom"]).concat(g),k=k.concat(["marginLeft","marginRight"]),f.find("*[width]").each(function(){var b=c(this),d=c.effects.scaledDimensions(b),e={height:d.height*x,width:d.width*z,outerHeight:d.outerHeight*x,
outerWidth:d.outerWidth*z};d={height:d.height*A,width:d.width*y,outerHeight:d.height*A,outerWidth:d.width*y};x!==A&&(e=c.effects.setTransition(b,h,x,e),d=c.effects.setTransition(b,h,A,d));z!==y&&(e=c.effects.setTransition(b,k,z,e),d=c.effects.setTransition(b,k,y,d));m&&c.effects.saveStyle(b);b.css(e);b.animate(d,a.duration,a.easing,function(){m&&c.effects.restoreStyle(b)})}));f.animate(w,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){var a=f.offset();0===w.opacity&&f.css("opacity",
v.opacity);m||(f.css("position","static"===q?"relative":q).offset(a),c.effects.saveStyle(f));b()}})});c.effects.define("scale",function(a,b){var d=c(this),e=a.mode;e=parseInt(a.percent,10)||(0===parseInt(a.percent,10)?0:"effect"!==e?0:100);d=c.extend(!0,{from:c.effects.scaledDimensions(d),to:c.effects.scaledDimensions(d,e,a.direction||"both"),origin:a.origin||["middle","center"]},a);a.fade&&(d.from.opacity=1,d.to.opacity=0);c.effects.effect.size.call(this,d,b)});c.effects.define("puff","hide",function(a,
b){a=c.extend(!0,{},a,{fade:!0,percent:parseInt(a.percent,10)||150});c.effects.effect.scale.call(this,a,b)});c.effects.define("pulsate","show",function(a,b){var d=c(this),e=a.mode,f="show"===e;e=2*(a.times||5)+(f||"hide"===e?1:0);var g=a.duration/e,h=0,k=1,l=d.queue().length;for((f||!d.is(":visible"))&&(d.css("opacity",0).show(),h=1);e>k;k++)d.animate({opacity:h},g,a.easing),h=1-h;d.animate({opacity:h},g,a.easing);d.queue(b);c.effects.unshift(d,l,e+1)});c.effects.define("shake",function(a,b){var d=
1,e=c(this),f=a.direction||"left",g=a.distance||20,h=a.times||3,k=2*h+1,l=Math.round(a.duration/k),m="up"===f||"down"===f?"top":"left";f="up"===f||"left"===f;var n={},p={},q={},r=e.queue().length;c.effects.createPlaceholder(e);n[m]=(f?"-\x3d":"+\x3d")+g;p[m]=(f?"+\x3d":"-\x3d")+2*g;q[m]=(f?"-\x3d":"+\x3d")+2*g;for(e.animate(n,l,a.easing);h>d;d++)e.animate(p,l,a.easing).animate(q,l,a.easing);e.animate(p,l,a.easing).animate(n,l/2,a.easing).queue(b);c.effects.unshift(e,r,k+1)});c.effects.define("slide",
"show",function(a,b){var d=c(this),e={up:["bottom","top"],down:["top","bottom"],left:["right","left"],right:["left","right"]},f=a.mode,g=a.direction||"left",h="up"===g||"down"===g?"top":"left",k="up"===g||"left"===g,l=a.distance||d["top"===h?"outerHeight":"outerWidth"](!0),m={};c.effects.createPlaceholder(d);var n=d.cssClip();var p=d.position()[h];m[h]=(k?-1:1)*l+p;m.clip=d.cssClip();m.clip[e[g][1]]=m.clip[e[g][0]];"show"===f&&(d.cssClip(m.clip),d.css(h,m[h]),m.clip=n,m[h]=p);d.animate(m,{queue:!1,
